...
[string] $DB_PROVIDER_AZSQL      = "System.Data.SqlClient"
[string] $DB_SERVER_NAME_AZSQL   = "YOU_SERVER.database.windows.net"
[string] $DB_NAME_AZSQL          = "Computers"
[string] $DB_USER_NAME_AZSQL     = "YOU_USER@YOU_SERVER"
[string] $DB_USER_PASS_AZSQL     = "YOU_PASSWORD"
...
[clsDb] $azsql = [clsDb]::new($DB_USER_NAME_AZSQL,$DB_USER_PASS_AZSQL,$DB_PROVIDER_AZSQL,$DB_SERVER_NAME_AZSQL,$DB_NAME_AZSQL )

$azsql.ExecuteCmd($azsql.CreateCommandSp("InsertPsBiosLogXml",  "@xmlText",$wmi.GetXmlString( $wmi.GetBiosXml())))
$azsql.ExecuteCmd($azsql.CreateCommandSp("InsertPsCpuLogXml",   "@xmlText",$wmi.GetXmlString( $wmi.GetCpuXml())))
$azsql.ExecuteCmd($azsql.CreateCommandSp("InsertPsHddLogXml",   "@xmlText",$wmi.GetXmlString( $wmi.GetHddXml())))
$azsql.ExecuteCmd($azsql.CreateCommandSp("InsertPsIpAddrLogXml","@xmlText",$wmi.GetXmlString( $wmi.GetIpXml())))
$azsql.ExecuteCmd($azsql.CreateCommandSp("InsertPsRamLogXml",   "@xmlText",$wmi.GetXmlString( $wmi.GetRamXml())))
$azsql.ExecuteCmd($azsql.CreateCommandSp("InsertPsUsersLogXml", "@xmlText",$wmi.GetXmlString( $wmi.GetUsersXml())))
$azsql.ExecuteCmd($azsql.CreateCommandSp("InsertPsVideoLogXml", "@xmlText",$wmi.GetXmlString( $wmi.GetVideoXml())))